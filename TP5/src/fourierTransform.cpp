...
void inverseDiscreteFourierTransform(const cv::Mat &imageFourierMagnitude, const cv::Mat &imageFourierPhase,
                                     cv::Mat &outputImage, const int cvType) {
...
cv::Mat fourierMagnitudeToDisplay(const cv::Mat &magnitudeImage) {
    ...
    cv::normalize(magnitudeImageToDisplay, magnitudeImageToDisplay, 0, 1,
